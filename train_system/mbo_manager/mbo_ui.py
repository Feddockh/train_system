...
class TestBench(QMainWindow):
    def __init__(self):
        ...
        self.position_header.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.authority_header.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.speed_header.setAlignment(Qt.AlignmentFlag.AlignCenter)
