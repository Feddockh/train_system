...
class MBOWindow(QMainWindow):
    def __init__(self):
        ...
        self.create_schedules.setFont(QFont('Times', 14))
...
class TestBench(QMainWindow):
    def __init__(self):
        ...
        self.trains_header.setFixedSize(200,100)
        self.line_header = QLabel('Line')
        self.line_header.setFixedSize(200,100)
        self.station_header = QLabel('Station')
        self.station_header.setFixedSize(200,100)
        self.position_header = QLabel('Position')
        self.position_header.setFixedSize(200,100)
        self.authority_header = QLabel('Authority')
        self.authority_header.setFixedSize(200,100)
        self.speed_header = QLabel('Commanded Speed')
        self.speed_header.setFixedSize(200,100)
